...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/mehlulidlamini/.cargo/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/mehlulidlamini/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/mehlulidlamini/.cargo/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.85.0 (4d91de4e4 2025-02-17)";
#[doc=r#"The output of `/Users/mehlulidlamini/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/mehlulidlamini/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
